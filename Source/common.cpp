...
namespace SCL
{
  ...
  unsigned int const SCL_MAJORVERSION = 2018;           ///< The Major version number (yyyy)
  unsigned int const SCL_MINORVERSION = 9;              ///< The Minor version number (mm)
  unsigned int const SCL_BUILDNUMBER  = 0x0051;         ///< The build numnber - incremented on each build.
